 ...
 */
@Slf4j
public class ProjectReactor2 {

    private static final String GROUP_ID = "org.openea.eap";
    private static final String ARTIFACT_ID = "eap";
    private static final String PACKAGE_NAME = "org.openea.eap";
    private static final String TITLE = "企业应用框架";
