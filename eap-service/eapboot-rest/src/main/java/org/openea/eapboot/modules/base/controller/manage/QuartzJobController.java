...
import org.openea.eapboot.modules.base.service.QuartzJobService;
...
@RequestMapping("/eapboot/quartzJob")
@Transactional
public class QuartzJobController {
    ...
    public Result<Object> pauseJob(@ModelAttribute QuartzJob job){
        ...
        try {
            ...
            throw new EapbootException("暂停定时任务失败");
        }
    ...
    public Result<Object> resumeJob(@ModelAttribute QuartzJob job){
        ...
        try {
            ...
            throw new EapbootException("恢复定时任务失败");
        }
        job.setStatus(CommonConstant.STATUS_NORMAL);
        quartzJobService.update(job);
    ...
    public void add(String jobClassName, String cronExpression, String parameter){
        ...
        try {
            ...
            throw new EapbootException("创建定时任务失败");
        } catch (Exception e){
            throw new EapbootException("后台找不到该类名任务");
        }
    }
    ...
    public void delete(String jobClassName){
        ...
        try {
            ...
            throw new EapbootException("删除定时任务失败");
        }
    }
