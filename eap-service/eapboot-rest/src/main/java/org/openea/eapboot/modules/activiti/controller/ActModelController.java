...
import org.openea.eapboot.modules.activiti.service.ActModelService;
...
@RequestMapping(value = "/eapboot/actModel")
@Transactional
public class ActModelController {
    ...
    public void export(@PathVariable String id, HttpServletResponse response) {
        ...
        try {
            ...
            if (nodeBytes == null) {
                throw new EapbootException("导出失败，模型数据为空");
            }
            ...
            log.error(e.toString());
            throw new EapbootException("导出模型出错");
        }
    }
