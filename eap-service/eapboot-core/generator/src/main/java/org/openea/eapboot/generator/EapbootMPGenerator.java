...
import static org.openea.eapboot.generator.EapbootGenerator.*;

/**
 * 代码生成器 Mybatis-Plus
 */
@Slf4j
public class EapbootMPGenerator {
     ...
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "org.openea.eapboot.modules.your.dao.mapper";
