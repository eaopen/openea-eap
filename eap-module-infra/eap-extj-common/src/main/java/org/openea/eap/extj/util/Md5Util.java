...
public class Md5Util {
    ...
    public static String hash(String s) {
        try {
            return new String(toHex(getStringMd5(s).getBytes(com.baomidou.mybatisplus.core.toolkit.Constants.UTF_8)).getBytes(com.baomidou.mybatisplus.core.toolkit.Constants.UTF_8), Constants.UTF_8);
        } catch (Exception e) {
            return s;
        }
    }
