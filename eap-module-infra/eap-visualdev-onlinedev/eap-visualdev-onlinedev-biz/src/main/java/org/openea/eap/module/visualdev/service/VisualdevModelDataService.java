package org.openea.eap.module.visualdev.service;
...
public interface VisualdevModelDataService extends SuperService<VisualdevModelDataEntity> {
    ...
    ActionResult visualCreate(VisualdevEntity visualdevEntity, MysqlxCrud.DataModel dataModel) throws WorkFlowException;

    ActionResult visualUpdate(VisualdevEntity visualdevEntity, MysqlxCrud.DataModel dataModel) throws WorkFlowException;
