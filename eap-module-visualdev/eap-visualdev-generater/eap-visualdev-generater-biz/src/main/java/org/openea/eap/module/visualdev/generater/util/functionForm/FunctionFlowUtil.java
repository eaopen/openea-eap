package org.openea.eap.module.visualdev.generater.util.functionForm;
...
import org.openea.eap.module.visualdev.base.model.ColumnDataModel;
import org.openea.eap.module.visualdev.base.model.DownloadCodeForm;
import org.openea.eap.module.visualdev.base.model.Template6.ColumnListField;
import org.openea.eap.module.visualdev.base.model.template6.AuthorityModel;
import org.openea.eap.module.visualdev.base.model.template6.BtnData;
import org.openea.eap.module.visualdev.constant.FileTypeConstant;
import org.openea.eap.module.visualdev.entity.FlowFormEntity;
import org.openea.eap.module.visualdev.database.util.TenantDataSourceUtil;
import org.openea.eap.module.visualdev.generater.model.FormDesign.ColumnChildListModel;
import org.openea.eap.module.visualdev.generater.util.common.FormCommonUtil;
import org.openea.eap.module.visualdev.generater.util.common.SuperQueryUtil;
import org.openea.eap.module.visualdev.base.util.SourceUtil;
import org.openea.eap.module.visualdev.base.util.VisualUtils;
...
import org.openea.eap.module.visualdev.generater.model.FormDesign.ColumnListDataModel;
import org.openea.eap.module.visualdev.generater.model.FormDesign.ColumnListModel;
import org.openea.eap.module.visualdev.generater.model.FormDesign.ListSearchGroupModel;
import org.openea.eap.module.visualdev.generater.model.GenBaseInfo;
import org.openea.eap.module.visualdev.generater.model.GenFileNameSuffix;
import org.openea.eap.module.visualdev.generater.model.SearchTypeModel;
import org.openea.eap.module.visualdev.generater.model.Template7Model;
import org.openea.eap.module.visualdev.generater.util.common.CodeGenerateUtil;
import org.openea.eap.module.visualdev.base.util.common.DataControlUtils;
import org.openea.eap.module.visualdev.generater.util.common.FunctionFormPublicUtil;
import org.openea.eap.module.visualdev.generater.util.custom.CustomGenerator;
import org.openea.eap.module.visualdev.model.visualJson.*;
import org.openea.eap.module.visualdev.model.visualJson.analysis.*;
import org.openea.eap.module.visualdev.model.visualJson.config.ConfigModel;
import org.openea.eap.module.visualdev.model.visualJson.props.PropsBeanModel;
import org.openea.eap.module.visualdev.model.visualJson.props.PropsModel;
import org.openea.eap.module.visualdev.base.model.print.PrintOption;
import org.openea.eap.module.visualdev.base.service.IPrintDevService;
import org.openea.eap.module.visualdev.util.*;
import org.openea.eap.module.visualdev.util.context.SpringContext;
import org.openea.eap.module.visualdev.util.visiual.JnpfKeyConsts;
...
public class FunctionFlowUtil implements CodeGenerateUtil {
    ...
    public void htmlTemplates(String fileName, VisualdevEntity entity, DownloadCodeForm downloadCodeForm,
        ...
        List<ColumnListModel> notChildColList = columnListModelList.stream().filter(copy ->
                !copy.getVModel().toLowerCase().startsWith("tablefield" )).collect(Collectors.toList());
        ...
        Map<String, List<ColumnListModel>> childFiledLists = columnListModelList.stream().filter(c ->
                c.getProp().toLowerCase().contains("tablefield" )).collect(Collectors.groupingBy(t -> t.getProp().substring(0, t.getProp().lastIndexOf("-" ))));
