...
// 文件上传接口
export const uploadFile = "/eapboot/upload/file"
// 验证码渲染图片接口
export const drawCodeImage = "/eapboot/common/captcha/draw/"
// 获取菜单
export const getMenuList = "/eapboot/permission/getMenuList"
// 获取数据字典
export const getDictData = "/eapboot/dictData/getByType/"
// Websocket
export const ws = "/eapboot/ws"
