...
export default {
    ...
    mounted(){
        ...
        if(this.value){
            ...
            this.form.path = window.__ctx +'/sys/sysFile/webuploader/previewImg/'+ this.value;
        }
    },
    data() {
        return {
    ...
    watch:{
        value(v){
            this.form.id = v;
            if(v){
                this.form.path = window.__ctx +'/sys/sysFile/webuploader/previewImg/'+ v
            }else {
                this.form.path = ""
            }
        }
    ...
    methods: {
        ...
        handleUploadSuccess(data) {
            if(data.path){
                this.form.path = window.__ctx +'/sys/sysFile/webuploader/previewImg/'+ data.id;
